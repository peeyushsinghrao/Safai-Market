      ...
      <div className="flex-1 p-4 pb-32 space-y-4">
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-2">
            <Badge variant={bundle.isActive ? "default" : "secondary"} className={cn(bundle.isActive ? "bg-green-100 text-green-800 border-green-200" : "")}>
              {bundle.isActive ? "Active" : "Inactive"}
            </Badge>
            <Button variant="ghost" size="sm" className="text-xs gap-1 h-7 text-muted-foreground" onClick={handleToggleActive}>
