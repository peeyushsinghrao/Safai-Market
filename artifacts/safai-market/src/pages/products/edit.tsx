...
export default function ProductEdit() {
  ...
  return (
    <div className="flex flex-col min-h-full bg-gray-50/60">
      <PageHeader title="Edit Product" subtitle={product.name} backTo={`/products/${id}`} />
      ...
      <form onSubmit={handleSubmit} className="flex-1 p-4 space-y-4 pb-24">
        ...
        <FormCard title="Stock & Unit">
          ...
          <p className="text-xs text-muted-foreground">To adjust stock, use the Purchase entry or Stock Movements screen.</p>
        </FormCard>
        ...
        <Button type="submit" className="w-full h-14 text-base font-bold rounded-2xl shadow-lg shadow-primary/20 active-elevate mt-2" disabled={updateProduct.isPending}>
